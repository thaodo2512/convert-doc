 ...
 * ---------------------------------------------------------------- */
extern void pdr_repo_populate_ext(struct pdr_repo_t *repo, void *ctx); /* fast zero-copy init */
extern void pdr_repo_populate(struct pdr_repo_t *repo, void *ctx);     /* rebuild callback    */

/* ----------------------------------------------------------------
 * Helper: print repository info
 * ---------------------------------------------------------------- */
static void print_repo_info(const struct pdr_repo_t *repo)
{
    const struct pdr_repo_info_t *info = pdr_repo_get_info(repo);
 ...
 * ---------------------------------------------------------------- */
static void dump_all_records(const struct pdr_repo_t *repo)
{
    ...
    while (1) {
        ...
        const struct pldm_pdr_hdr_t *hdr = (const struct pldm_pdr_hdr_t *)data;
 ...
 * ---------------------------------------------------------------- */
static void find_all_by_type(const struct pdr_repo_t *repo,
...
int main(void)
{
    ...
    printf("--- 4. GetPDR for handle 1 ---\n");
    {
        ...
        if (rc == 0) {
            ...
            const uint8_t *payload = data + sizeof(struct pldm_pdr_hdr_t);
